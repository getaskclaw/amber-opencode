# 2026-W38 correction notice — amber-opencode: additive correction to published scores
...
- Count for this repo in this notice: **0 standalone published cells reversed · 3 standalone published cells held** (count = standalone published cells = actual table rows).
- **Scope in one line**: 3 cells in W37 are held — the 16/23 headline may move up.
...
|---|---|---|---|---|---|
| A-cdc3d11a | `dbb207a3118d` | W37 | ocgo column ✗ -2 | held (re-exam pending) | named and removed from the board; excluded from all aggregates pending re-exam |
| A-ea80d793 | `1d69841b029e` | W37 | ocgo column ✗ -2 | held (re-exam pending) | same |
| A-d9b79b46 | `d6d63130ecc6` | W37 | ocgo column ✗ | held (re-exam pending) | same |
